...
## :cityscape: LoD3 Road Space Models in CityGML
...
```bash
git clone --depth 1 git@github.com:savein/open-data.git
```

* :inbox_tray: Direct download from [archive.org](https://archive.org/details/lod3-road-space-models-ingolstadt-citygml): [CityGML Dataset](https://archive.org/download/lod3-road-space-models-ingolstadt-citygml/LoD3RoadSpaceModels_Ingolstadt_CityGML.zip), [SketchUp Projects](https://archive.org/download/lod3-road-space-models-ingolstadt-citygml/LoD3RoadSpaceModels_Ingolstadt_SketchUp.zip) (the download as GitHub zip archive does not work due to [LFS](https://git-lfs.github.com))
...
* :page_facing_up: License: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)
